	...
	<div class="min-h-screen flex items-center justify-center bg-surface-gray-2">
		<div class="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mx-4">
			...
			<div v-if="loading" class="text-center">
				...
				<h2 class="text-lg font-semibold text-ink-gray-9">{{ __('Connecting to Microsoft Teams...') }}</h2>
			...
			<div v-else-if="success" class="text-center">
				...
				<p class="text-ink-gray-5 mt-2">{{ __('Microsoft Teams has been successfully connected.') }}</p>
...
const exchangeToken = createResource({
	url: 'lms.lms.api.microsoft_teams_oauth_callback',
	makeParams() {
		return {
